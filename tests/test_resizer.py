...
eval_config = {'train_q': {'synset': dataset.synset_list[:2]},
               ...
               'npc_train': 150, 'npc_test': 50, 'num_splits': 2, 'npc_validate': 0,
               'split_by': 'synset',
               'labelfunc': 'synset',
               'metric_screen': 'classifier',
               'metric_kwargs': {'model_type': 'MCC2', 'normalize': False}}

cProfile.run('compute_metric(pixel_features, dataset, eval_config)')
